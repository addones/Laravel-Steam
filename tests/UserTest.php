...
class UserTest extends BaseTester {
    ...
    {
        $this->setExpectedException('Dawoea\SteamApi\Exceptions\UnrecognizedId');
    ...
    {
        $this->assertInstanceOf('Dawoea\SteamApi\Containers\Player', $friendsList[0]);
        $this->assertInstanceOf('Dawoea\SteamApi\Containers\Id', $friendsList[0]->steamIds);
    }
}